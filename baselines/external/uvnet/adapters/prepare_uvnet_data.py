"""Prepare UV-Net-compatible external baseline directories from PartGraph cache."""
...
def prepare_uvnet_data(*, partgraph_cache_dir: str | Path, output_dir: str | Path, dataset: str) -> dict[str, str]:
    ...
    write_export_manifest(output / "manifest.json", dataset=dataset, parts=parts, extra={"format": "uvnet"})
    return {
